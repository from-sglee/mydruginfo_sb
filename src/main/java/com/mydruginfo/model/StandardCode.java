...
public class StandardCode {
	...
	String package_type;
	String item_code;				// not null
	String date_authorization;
	String drug_type;
	String representative_code;		// not null
	...
	public StandardCode(String drug_name_kr, String company_name, String item_code, String representative_code, String standard_code) {
		super();
	...
	public StandardCode(String drug_name_kr, String company_name, String pharma_standard, String quantity,
			String formulation_type, String package_type, String item_code, String date_authorization, String drug_type,
			String representative_code, String standard_code, String product_code, String common_name_code, String memo,
	...
	public String getRepresentative_code() {
		return representative_code;
	}
	public void setRepresentative_code(String representative_code) {
		this.representative_code = representative_code;
	}
	...
	public String toString() {
		return "StandardCode [drug_name_kr=" + drug_name_kr + ", company_name=" + company_name + ", pharma_standard="
				...
				+ specialcare_type + ", reading_equipment=" + reading_equipment + ", reg_date=" + reg_date + "]";
	}
